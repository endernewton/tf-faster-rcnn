...
We only tested it on plain VGG16 architecture so far. Our best performance as of January 2017 (single model, no multi-scale, no multi-stage bounding box regression, no skip-connection):
